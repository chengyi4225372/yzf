...
class Medialist extends BasicAdmin {

    private $dataform = 'media_list';
    public $table ='media_cate';
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/medialist/index')];
