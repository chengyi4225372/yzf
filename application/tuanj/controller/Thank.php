...
class Thank extends BasicAdmin {

    private $dataform = 'thank';
    ...
    public function remen(){
        ...
        $res = Db::name('thank')->where('id',$id)->update(['tuijian'=>$tuijian>0?0:1]);
    ...
    protected function _form_result($result) {
        if ($result !== false) {
            list($base, $spm, $url) = [url('@admin'), $this->request->get('spm'), url('tuanj/thank/index')];
