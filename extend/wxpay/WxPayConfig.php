...
class WxPayConfig
{
     ...
     * @var string
     */
    const APPID = 'wx426b3015555a46be';//您的app
    const MCHID = '1225312702';//mchid
    const KEY = 'e10adc3949ba59abbe56e057f20f883e';//您的key
    const APPSECRET = '01c6d59a3f9024db6336662ac95c8e74';//微信密钥
    const NOTIFY_URL = 'jjhe.me/index/wxpay/notify';
